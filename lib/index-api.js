...
module.exports = function(config, auth, storage) {
  ...
  app.param('scoped_package1', validate_pkg)
  app.param('scoped_package2', validate_pkg)
  ...
  // TODO: anonymous user?
  app.get('/@:scoped_package1/:scoped_package2/:version?', can('access'), function(req, res, next) {
    var package = '@' + req.params.scoped_package1 + '/' + req.params.scoped_package2
    storage.get_package(package, { req: req }, function(err, info) {
